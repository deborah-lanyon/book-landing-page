...
router
  .group(() => {
    ...
    router.put('/settings-content', [BilingualEditorController, 'updateSettings']).as('admin.bilingual.updateSettings')
    router.post('/translations', [BilingualEditorController, 'saveTranslations']).as('admin.bilingual.saveTranslations')
    router.put('/sections/:id', [BilingualEditorController, 'updateSection']).as('admin.bilingual.updateSection')
    router.post('/sections-new', [BilingualEditorController, 'createSection']).as('admin.bilingual.createSection')
    router.delete('/sections-content/:id', [BilingualEditorController, 'deleteSection']).as('admin.bilingual.deleteSection')
  })
  .prefix('/admin')
  .use(middleware.auth())
